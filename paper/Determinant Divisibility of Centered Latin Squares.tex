...
\usepackage{array}
\usepackage{hyperref}
\usepackage{xurl}               % permissive URL line-breaking
...
% ══════════════════════════════════════════════════════════════════════════
\section{Smith normal form and $p$-adic bounds}\label{sec:snf}
% ══════════════════════════════════════════════════════════════════════════
...
There are exactly $9408$ reduced Latin squares of order~$6$ (first row
${}={}$ first column ${}= (1,2,3,4,5,6)$).  Every Latin square of
